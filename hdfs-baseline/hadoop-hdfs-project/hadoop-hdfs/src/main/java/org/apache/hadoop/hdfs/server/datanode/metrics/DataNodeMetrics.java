...
public class DataNodeMetrics {
  ...
  public long getFailedBlocksReplicated() {
    return failedBlocksReplicated.value();
  }

  public void incrBytesReplicated(long bytes) {
    bytesReplicated.incr(bytes);
  }

  public long getBytesReplicated() {
    return bytesReplicated.value();
  }
