...
public interface ClientProtocol {
  ...
  /**
   * @param ioDeclarationType type of IO
   * @param src file name
   * @param offset range start offset (bytes)
   * @param length range length (bytes)
   * @param deadline timestamp
   * @throws IOException if an IO error occurred
   */
  default void declareIO(String ioDeclarationType, String src, long offset, long length, String deadline)
   ...
   * @param offsets range start offsets (bytes)
   * @param lengths range lengths (bytes)
   * @param segmentsNeeded number of segments needed
   * @param deadline timestamp
   * @return list of segment indices selected by planner
   * @throws IOException if an IO error occurred
   */
  default List<Long> declareIOs(String ioDeclarationType, List<String> paths, List<Long> offsets, List<Long> lengths, long segmentsNeeded, String deadline)
      throws IOException, NotImplementedException {
    throw new NotImplementedException();
  }
   ...
   * @param segmentsNeeded number of segments needed
   * @param deadline timestamp
   * @param allowPartialCompletion true if this request can be completed in parts (i.e. scheduled multiple times)
   * @return declaration uuid
   * @throws IOException if an IO error occurred
   */
  default String declareIOsAsync(String ioDeclarationType, List<String> paths, List<Long> offsets, List<Long> lengths,
  ...
  /**
   * @param requestUuid declaration uuid to check status of
   * @return list of segment indices selected by planner
   * @throws IOException
   * @throws NotImplementedException
   */
  default List<Long> pollDeclaration(String requestUuid)
      throws IOException, NotImplementedException {
    throw new NotImplementedException();
  }
   ...
   *
   * @param ioDeclarationType type of IO
   * @param blockSets list of block sets
   * @param blockSetsNeeded number of block sets needed
   * @param deadline timestamp
   * @return list of block set indices selected by planner
   * @throws IOException if an IO error occurred
   */
  default List<Long> declareIOBlocks(String ioDeclarationType, List<List<LocatedBlock>> blockSets, long blockSetsNeeded, String deadline)
      throws IOException, NotImplementedException {
    throw new NotImplementedException();
  }
