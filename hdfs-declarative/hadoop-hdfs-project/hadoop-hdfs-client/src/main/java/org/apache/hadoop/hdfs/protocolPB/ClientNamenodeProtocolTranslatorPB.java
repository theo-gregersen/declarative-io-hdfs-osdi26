...
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.DeclareIORequestProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.DeclareIOResponseProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.SegmentProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.DeclareIOsRequestProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.DeclareIOsResponseProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.DeclareIOsAsyncRequestProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.DeclareIOsAsyncResponseProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.PollDeclarationRequestProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.BlockSetProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.DeclareIOBlocksRequestProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.DeclareIOBlocksResponseProto;
...
public class ClientNamenodeProtocolTranslatorPB implements
  ...
  public void declareIO(String ioDeclarationType, String src, long offset, long length, String deadline)
      throws IOException {
    DeclareIORequestProto req = DeclareIORequestProto
        .newBuilder()
        .setIoDeclarationType(ioDeclarationType)
        .setPath(src)
        .setOffset(offset)
        .setLength(length)
        .setDeadline(deadline)
        .build();
    DeclareIOResponseProto resp = ipc(() -> rpcProxy.declareIO(null, req));
  }
  ...
  public List<Long> declareIOs(String ioDeclarationType, List<String> paths, List<Long> offsets, List<Long> lengths, long segmentsNeeded, String deadline)
      throws IOException {
    List<SegmentProto> segments = new ArrayList<>();
    for (int i = 0; i < paths.size(); i++) {
      segments.add(SegmentProto.newBuilder()
          .setPath(paths.get(i))
          .setOffset(offsets.get(i))
          .setLength(lengths.get(i))
          .build());
    }

    DeclareIOsRequestProto req = DeclareIOsRequestProto
        .newBuilder()
        .setIoDeclarationType(ioDeclarationType)
        .addAllSegments(segments)
        .setSegmentsNeeded(segmentsNeeded)
        .setDeadline(deadline)
        .build();
    DeclareIOsResponseProto resp = ipc(() -> rpcProxy.declareIOs(null, req));
    return resp.getSegmentsSelectedList();
  }
  ...
  public String declareIOsAsync(String ioDeclarationType, List<String> paths, List<Long> offsets, List<Long> lengths,
    ...
    DeclareIOsAsyncRequestProto req = DeclareIOsAsyncRequestProto
        .newBuilder()
        .setIoDeclarationType(ioDeclarationType)
        .addAllSegments(segments)
        .setSegmentsNeeded(segmentsNeeded)
        .setDeadline(deadline)
        .setAllowPartialCompletion(allowPartialCompletion)
        .build();
    DeclareIOsAsyncResponseProto resp = ipc(() -> rpcProxy.declareIOsAsync(null, req));
    return resp.getRequestUuid();
  }

  @Override
  public List<Long> pollDeclaration(String requestUuid)
      throws IOException {
    PollDeclarationRequestProto req = PollDeclarationRequestProto
        .newBuilder()
        .setRequestUuid(requestUuid)
        .build();
    DeclareIOsResponseProto resp = ipc(() -> rpcProxy.pollDeclaration(null, req));
    return resp.getSegmentsSelectedList();
  }
  ...
  public List<Long> declareIOBlocks(String ioDeclarationType, List<List<LocatedBlock>> blockSets, long blockSetsNeeded, String deadline)
    ...
    List<BlockSetProto> blockSetsProtos = new ArrayList<>();
    for (List<LocatedBlock> blockSet : blockSets) {
      blockSetsProtos.add(BlockSetProto.newBuilder()
          .addAllBlocks(PBHelperClient.convertLocatedBlocks2(blockSet))
          .build());
    }

    DeclareIOBlocksRequestProto req = DeclareIOBlocksRequestProto
        .newBuilder()
        .setIoDeclarationType(ioDeclarationType)
        .addAllBlockSets(blockSetsProtos)
        .setDeadline(deadline)
        .build();
    DeclareIOBlocksResponseProto resp = ipc(() -> rpcProxy.declareIOBlocks(null, req));
    return resp.getBlockSetsSelectedList();
  }
