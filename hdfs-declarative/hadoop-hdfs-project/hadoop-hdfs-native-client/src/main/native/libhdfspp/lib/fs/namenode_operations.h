...
public:
  ...
  void DeclareIO(const std::string &declarationType,
  ...
  void DeclareIOs(const std::string &declarationType,
                  const std::vector<Segment> segments,
                  const uint64_t segmentsNeeded,
                  const std::string &deadline,
                  const std::function<void(const Status &, std::vector<uint64_t> &)> &handler);

  void DeclareIOsAsync(const std::string &declarationType,
                       const std::vector<Segment> segments,
                       const uint64_t segmentsNeeded,
                       const std::string &deadline,
  ...
  void PollDeclaration(const std::string &requestUuid,
                       const std::function<void(const Status &, std::vector<uint64_t> &)> &handler);
