...
public class NamenodeProtocolServerSideTranslatorPB implements
  ...
  @Override
  public NamenodeProtocolProtos.AddBalancingResponseProto addBalancerRequest(RpcController controller, NamenodeProtocolProtos.DeclareIOBlocksRequestProto request) throws ServiceException {
    impl.addBalancingRequest(request);
    return NamenodeProtocolProtos.AddBalancingResponseProto.newBuilder().build();
  }

  @Override
  public NamenodeProtocolProtos.BalancerHeartbeatResponseProto sendHeartbeat(RpcController controller, NamenodeProtocolProtos.BalancerHeartbeatRequestProto request) throws ServiceException {
    NamenodeProtocolProtos.BalancerHeartbeatResponseProto.Builder builder = NamenodeProtocolProtos.BalancerHeartbeatResponseProto.newBuilder();
    try {
      builder.setResponse(PBHelper.convertIOPlannerResponseBalancer(impl.sendHeartbeat().getQueue()));
    } catch (IOException e) {
      throw new ServiceException(e);
    }
