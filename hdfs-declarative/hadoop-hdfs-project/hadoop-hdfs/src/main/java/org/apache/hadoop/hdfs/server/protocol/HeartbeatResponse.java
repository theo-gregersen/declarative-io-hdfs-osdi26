...
public class HeartbeatResponse {
  ...
  private ConcurrentHashMap<String, DeclareIOBlocksRequestProto> queue;
  ...
  public HeartbeatResponse(DatanodeCommand[] cmds,
                           NNHAStatusHeartbeat haStatus, RollingUpgradeStatus rollingUpdateStatus,
                           long fullBlockReportLeaseId, ConcurrentHashMap<String, DeclareIOBlocksRequestProto> queue) {
    commands = cmds;
    this.haStatus = haStatus;
    this.rollingUpdateStatus = rollingUpdateStatus;
    this.fullBlockReportLeaseId = fullBlockReportLeaseId;
  ...
  public ConcurrentHashMap<String, DeclareIOBlocksRequestProto> getQueue() {return queue;}
