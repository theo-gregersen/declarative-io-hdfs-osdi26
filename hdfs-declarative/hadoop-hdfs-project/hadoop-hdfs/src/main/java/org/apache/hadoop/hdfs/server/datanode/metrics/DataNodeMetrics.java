...
public class DataNodeMetrics {
  ...
  @Metric MutableCounterLong bytesReplicated;
  @Metric MutableCounterLong failedBlocksReplicated;
  ...
  public long getBlocksReplicated() { return blocksReplicated.value(); }

  public void incrFailedBlocksReplicated() {
    failedBlocksReplicated.incr();
  }

  public long getFailedBlocksReplicated() { return failedBlocksReplicated.value(); }

  public void incrBytesReplicated(long bytes) { bytesReplicated.incr(bytes); }

  public long getBytesReplicated() { return bytesReplicated.value(); }
  ...
  public long getECFailedReconstructionTasks() {
    return ecFailedReconstructionTasks.value();
  }
