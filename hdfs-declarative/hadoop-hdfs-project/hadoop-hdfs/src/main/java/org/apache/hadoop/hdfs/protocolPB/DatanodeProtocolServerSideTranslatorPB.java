...
public class DatanodeProtocolServerSideTranslatorPB implements
  ...
  public HeartbeatResponseProto sendHeartbeat(RpcController controller,
    ...
    try {
      ...
      ConcurrentHashMap<String, DeclareIOBlocksRequestProto> queue = request.hasRequests() ? PBHelper.convertNestedRequest(request.getRequests()) : null;
    ...
    builder.setResponse(PBHelper.convertToNestedRequest(response.getQueue()));
