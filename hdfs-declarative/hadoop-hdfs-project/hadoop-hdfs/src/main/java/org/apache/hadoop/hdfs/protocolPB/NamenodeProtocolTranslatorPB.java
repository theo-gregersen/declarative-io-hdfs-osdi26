...
public class NamenodeProtocolTranslatorPB implements NamenodeProtocol,
  ...
  public void addBalancingRequest(NamenodeProtocolProtos.DeclareIOBlocksRequestProto request) throws ServiceException {
    rpcProxy.addBalancerRequest(NULL_CONTROLLER, request);
  }

  public BalancerHeartbeatResponse sendHeartbeat() throws IOException {
    NamenodeProtocolProtos.BalancerHeartbeatRequestProto req = PBHelper.convert();
    NamenodeProtocolProtos.BalancerHeartbeatResponseProto rsp = ipc(() -> rpcProxy.sendHeartbeat(NULL_CONTROLLER, req));
    return PBHelper.convert(rsp);
  }
