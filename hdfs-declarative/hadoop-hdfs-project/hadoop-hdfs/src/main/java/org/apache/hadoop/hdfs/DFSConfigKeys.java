...
public class DFSConfigKeys extends CommonConfigurationKeys {
  public static final String DECLARATIVE_SCHEDULING_PERIOD_SECONDS_KEY = "declarative.scheduling.period.seconds";
  public static final long DECLARATIVE_SCHEDULING_PERIOD_SECONDS_DEFAULT = 60;
  public static final String DECLARATIVE_SCHEDULING_MAX_MBS_KEY = "declarative.scheduling.max.mbs";
  public static final long DECLARATIVE_SCHEDULING_MAX_MBS_DEFAULT = 1000000000;
  public static final String DECLARATIVE_SCHEDULING_DISPATCH_CLUSTERS_KEY = "declarative.scheduling.dispatch.clusters";
  public static final long DECLARATIVE_SCHEDULING_DISPATCH_CLUSTERS_DEFAULT = 10;
  public static final String DECLARATIVE_SCHEDULING_RATE_RATIO_KEY = "declarative.scheduling.rate.ratio";
  public static final float DECLARATIVE_SCHEDULING_RATE_RATIO_DEFAULT = 0.5f;

  public static final String DECLARATIVE_SCRUBBING_PERIOD_SECONDS_KEY = "declarative.scrubbing.period.seconds";
  public static final long DECLARATIVE_SCRUBBING_PERIOD_SECONDS_DEFAULT = 0;
  public static final String DECLARATIVE_SCRUBBING_DELAY_SECONDS_KEY = "declarative.scrubbing.delay.seconds";
  public static final long DECLARATIVE_SCRUBBING_DELAY_SECONDS_DEFAULT = 0;
  public static final String DECLARATIVE_SCRUBBING_DELAY_BLOCKS_KEY = "declarative.scrubbing.delay.blocks";
  public static final long DECLARATIVE_SCRUBBING_DELAY_BLOCKS_DEFAULT = 0;

  public static final String DECLARATIVE_SCRUBBING_DEADLINE_SECONDS_KEY = "declarative.scrubbing.deadline.seconds";
  public static final long DECLARATIVE_SCRUBBING_DEADLINE_SECONDS_DEFAULT = 1200;
  public static final String DECLARATIVE_REBALANCE_DEADLINE_SECONDS_KEY = "declarative.rebalance.deadline.seconds";
  public static final long DECLARATIVE_REBALANCE_DEADLINE_SECONDS_DEFAULT = 600;
  public static final String DECLARATIVE_RECONSTRUCTION_DEADLINE_SECONDS_KEY = "declarative.reconstruction.deadline.seconds";
  public static final long DECLARATIVE_RECONSTRUCTION_DEADLINE_SECONDS_DEFAULT = 60;

  public static final String DECLARATIVE_SCRUBBING_RATE_KEY = "declarative.scrubbing.rate";
  public static final long DECLARATIVE_SCRUBBING_RATE_DEFAULT = 0;
  public static final String DECLARATIVE_REBALANCE_RATE_KEY = "declarative.rebalance.rate";
  public static final long DECLARATIVE_REBALANCE_RATE_DEFAULT = 0;
  public static final String DECLARATIVE_RECONSTRUCTION_RATE_KEY = "declarative.reconstruction.rate";
  public static final long DECLARATIVE_RECONSTRUCTION_RATE_DEFAULT = 0;

  public static final String DECLARATIVE_TRANSCODE_DIR_KEY = "declarative.transcode.dir";
  public static final String DECLARATIVE_TRANSCODE_DIR_DEFAULT = "/.transcoded";

  public static final String DECLARATIVE_CACHE_DELAY_MS_KEY = "declarative.cache.delay.ms";
  public static final long DECLARATIVE_CACHE_DELAY_MS_DEFAULT = 5000;
